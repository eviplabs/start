namespace AttaxxPlus.Model
{
    ...
    public class TriGame : GameBase
    {
        public TriGame(int size) : base()
        {
        ...
        public override void InitializeGame()
        {
            ...
            Fields[0, 0].Owner = 1;
			Fields[Fields.GetLength(0) - 1, 0].Owner = 2;
			Fields[Fields.GetLength(0) - 1, Fields.GetLength(1) - 1].Owner = 3;
		}
    }
}
